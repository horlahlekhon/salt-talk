...
function sl_widgets_import() {

	$file_location = "widgets.imp";

	$wipath = apply_filters( "sl_widget_import_file_path", $file_location );

	$file = get_template_directory()."/7league/xml/".$wipath; 
  

/* !!!! NO WORRY, THIS IS ONLY NECESSARY FOR WIDGETS IMPORT !!!! */	$data = file_get_contents( $file );
