...
$remote_file = $addr->get( 'ThemeURI' ) ."wp-content/themes/".get_template()."/7league/version.php";
...
$theme_update_notice ="<p>New theme version available. Please download and install the new version.</p>";
...
function theme_compare_ver() { 
	global $remote_file, $local_version,$theme_sn;
		...
		if ($local_version == $remote_version) {
		 	...
		 	echo "Can't Connect to update server on $remote_file";
		}
}	
