...
if(load_option("woocommerce")=="on")
	...
	function woocommerce_header_add_to_cart_fragment( $fragments ) {
		...
		?>
		<a class="cart-contents cart-number-<?php echo $woocommerce->cart->cart_contents_count; ?>" href="<?php echo $woocommerce->cart->get_cart_url(); ?>" title="<?php _e('View your shopping cart', 'woothemes'); ?>"><i class='icon-shopping-cart fa fa-shopping-cart'></i><em><?php echo $woocommerce->cart->cart_contents_count; ?></em></a>
		<?php
...
class Menu_With_Description extends Walker_Nav_Menu 
	...
	function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0)
		...
		if( $menuicon[0] != "" ) {
			$item_output .= "<i class='fa fa-".$menuicon[0]." icon-".$menuicon[0]."'></i>";
		}
