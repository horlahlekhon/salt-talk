...
<div id="content" class="equal_height"> 
	<div id='masonry'>	
		...
		<?php $ix=0; 
		query_posts(array( 'post_type' => 'post', 'paged' => get_query_var('paged'), 'posts_per_page'=>$post_per_page ));  
		?>
		<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
			<?php $ix++;  ?>
			<li class="portfolio-lists-item post-masonry-entry <?php echo $clear; ?>"> 
